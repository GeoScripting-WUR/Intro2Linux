...
Starting and stopping R from the terminal:
...
Make sure your script is clear and reproducible. There is not need to upload your shell script (you can copy the code directly 
within the BlackBoard reply zone as text,
