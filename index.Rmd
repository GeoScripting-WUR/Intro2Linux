...
[Discussion session and feedback](https://geoscripting-wur.github.io/Intro2Linux/Slides.html)
...
- Getting comfortable within OSGEO-Linux environment
    ...
    - Launching Rstudio and using Git within Linux
    - ?Knowing that there is a `QGIS` Python Console
