...
See this website (http://live.osgeo.org/) for more information. We will use OSGEO-live via VMware workstation player (see [here](https://geoscripting-wur.github.io/system_setup/) for instruction, and will also explain this in the lesson on Tuesday afternoon).
...
Make sure your script is clear and reproducible. There is no need to upload your shell script (you can copy the code directly within the BlackBoard reply zone as text)
