...
```{block, type="alert alert-info"}SS
...
Another increasingly popular category of resources is generative AI — tools that can help generate or explain code. As covered in the previous tutorial, this includes chatbots like ChatGPT, and autocomplete tools like GitHub Copilot. These tools can be helpful, but they should be used thoughtfully and critically.
