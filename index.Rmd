...
You should now see some information about the raster file, for example the coordinate system, the cell size, and some statistics about the rasters bands.
...
- For macOS users and introduction to use the terminal on macOS
    ...
    - [Learn the Mac OS X command line](http://blog.teamtreehouse.com/introduction-to-the-mac-os-x-command-line)
