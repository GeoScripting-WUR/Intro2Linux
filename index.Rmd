...
Write a shell script that:
 ...
 - resampels the Landsat data to pixels of 60 m
 - reprojects the landsat data to WGS Lat/long
 - convert the *.tif file (i.e. a geotif) to *.png

Copy the text of your shell script in an e-mail per team and set it to me before friday (1030u). Do not forget to add a teamname and date at the top of your script.
