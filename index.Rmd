...
## Getting started with Bash in the terminal

See the following tutorial - try it out.
...
http://www.hackmac.org/articles/bash/bash-101-history-of-bash-and-terminal/
On Mac customizing your Bash environment:
