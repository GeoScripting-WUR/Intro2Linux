...
First go to [https://portal.live.surfresearchcloud.nl/](https://portal.live.surfresearchcloud.nl/) and log in using your WUR account. Use this link [TODO](TODO) to ask for access to the *Wageningen University Geoscripting* collaboration. We (the staff) have to accept access to this collaboration, and create a virtual machine (VM) for your group. In the meantime, you can set up your two factor authentication:
...
The tutorial above allows you to access the VM in-browser. There are however alternatives, for which we provide a tutorial below.
